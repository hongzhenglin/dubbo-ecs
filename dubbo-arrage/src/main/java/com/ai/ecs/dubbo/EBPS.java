...
public class EBPS {
	...
	public interface PARAMSTYPE{
		...
		public final static String PARAM_JSTYPE="JS";
		public final static String PARAM_OGNLTYPE="OGNL";
		public final static String PARAM_JAVASCRIPTTYPE="JAVASCRIPT";
		public final static String PARAM_TYPE="com.ech.eworkflow.data.JSONObject";
		public final static String RESULT_INFO="X_RESULTINFO";
		public final static String RESULT_CODE="X_RESULTCODE";
		/**表结构缓存名称*/
		public final static String TABLE_STRUCT_CACHE_NAME="TABLE_STRUT_CACHE_NAME";
