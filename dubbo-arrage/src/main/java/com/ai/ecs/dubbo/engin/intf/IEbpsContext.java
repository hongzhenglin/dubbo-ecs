...
public interface IEbpsContext {
	...
	// public ScriptEngine getScriptEngine();
      ...
      */   	 
	   ...
	   * @Exception 异常说明
	   * @author：wuwenhui
	   * createDate：Mar 29, 2013 9:59:53 AM 
	   * 修改人： 
	   * 修改时间：
	   * 修改备注：
	   */
	  ...
	  * @Exception 异常说明
	  * @author：wuwenhui
	  * createDate：Mar 29, 2013 10:00:18 AM 
	  * 修改人： 
	  * 修改时间：
	  * 修改备注：
	  */
	  ...
	  * @Exception 异常说明
	  * @author：wuwenhui
	  * createDate：Apr 8, 2013 2:05:07 PM 
	  * 修改人： 
	  * 修改时间：
	  * 修改备注：
	  */
	  ...
	  * @Exception 异常说明
	  * @author：wuwenhui
	  * createDate：Apr 8, 2013 2:07:00 PM 
	  * 修改人： 
	  * 修改时间：
	  * 修改备注：
	  */
	  ...
	  * @Exception 异常说明
	  * @author：wuwenhui
	  * createDate：Apr 8, 2013 2:29:30 PM 
	  * 修改人： 
	  * 修改时间：
	  * 修改备注：
	  */
	 ...
	 */
	  ...
	  * 
	 * @Title: getValueByKey 
	 * @Description: TODO(根据节点出、入参数KEY和业务参数KEY，获取业务参数KEY对应的值,如果有相同的业务KEY，那么返回值运行时为LIST)
	 * @author：rentao
	 * @create：May 14, 2014
	 * @param name
	 * @return    设定文件 
	 ...
	 * @throws
	  */
	 public Object getValueByKey(String outname, String name);
